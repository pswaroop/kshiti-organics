  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between h-20 relative">
        ...
        {/* 1. LOGO IMAGE (Extreme Left) */}
        <a href="/" className="flex-shrink-0 z-10 flex items-center gap-2">
          <img
            src="/favicon.svg"
            alt="Kshiti Organics Logo"
            // Adjusted size for better fit on extreme left
            className="h-14 w-14 sm:h-20 sm:w-20 object-contain transition-transform duration-300 hover:scale-105"
          />
          
          {/* DESKTOP TEXT: Only visible on md screens and up (Side-by-side with logo) */}
        ...
        {/* 2. MOBILE BRAND NAME (Absolute Center) */}
        {/* This is positioned absolutely to ensure it's dead center on mobile, regardless of other elements */}
        <a 
          href="/" 
          className="md:hidden absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center text-center z-0"
        >
          <h1 className="font-display text-lg font-bold text-black leading-tight whitespace-nowrap">
            <span className="text-green-800">K</span>shiti Organics
          </h1>
