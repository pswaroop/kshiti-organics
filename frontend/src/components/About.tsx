...
const About: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      title: "Farm Fresh",
      description:
        "Directly sourced from local farmers, ensuring maximum freshness and quality.",
    },
    {
      icon: Users,
      title: "Community Focused",
      description:
        "Supporting local farming communities and promoting sustainable agriculture.",
    },
    {
      icon: Award,
      title: "Quality Assured",
    ...
    },
    {
      ...
      title: "Trusted Brand",
      description:
        "Building trust through transparency, integrity, and consistent excellence.",
    },
  ];
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Bringing nature's finest organic produce from local farms directly
            to your doorstep
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Founded with a passion for healthy living and sustainable
              agriculture, Kshiti Organic has been connecting communities with
              premium organic products since our inception. We believe that
              everyone deserves access to pure, chemical-free food that
              nourishes both body and soul.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Working closely with dedicated local farmers, we ensure that every
              product meets our strict organic standards. Our commitment goes
              beyond just selling products—we're building a movement towards
              healthier lifestyles and a more sustainable future.
            </p>

            {/* New FSSAI Highlight Section */}
            <div className="mt-6 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100 rounded-xl p-5 flex items-start gap-4 shadow-sm">
              <div className="bg-white p-2 rounded-lg shadow-sm border border-green-100 flex-shrink-0">
                <img
              ...
              <div>
                ...
                <p className="text-green-700/80 text-xs mt-1">
                  Ensuring the highest standards of food safety and quality for
                  your family.
                </p>
              </div>
            </div>
